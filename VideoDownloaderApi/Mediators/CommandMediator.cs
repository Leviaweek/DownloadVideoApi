...
public sealed class CommandMediator(IEnumerable<IDownloadMediaCommandHandler> downloadMediaCommandHandlers): ICommandMediator<ICommand<IResponse<IResult, IError>>>
{
